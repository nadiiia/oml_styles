...
<qgis version="3.2.0-Bonn" simplifyLocal="1" simplifyAlgorithm="0" minScale="1e+8" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1" maxScale="28350" readOnly="0" hasScaleBasedVisibilityFlag="1" simplifyDrawingHints="1">
  <renderer-v2 symbollevels="0" type="categorizedSymbol" attr="classifica" forceraster="0" enableorderby="0">
    <categories>
      <category label="Multi Track" symbol="0" render="true" value="Multi Track"/>
      <category label="Narrow Gauge" symbol="1" render="true" value="Narrow Gauge"/>
      <category label="Single Track" symbol="2" render="true" value="Single Track"/>
    </categories>
    <symbols>
      ...
      <symbol type="line" name="1" clip_to_extent="1" alpha="1">
        ...
        <layer class="MarkerLine" locked="0" pass="0" enabled="1">
          ...
          <symbol type="marker" name="@1@1" clip_to_extent="1" alpha="1">
    ...
    <source-symbol>
      <symbol type="line" name="0" clip_to_extent="1" alpha="1">
        <layer class="SimpleLine" locked="0" pass="0" enabled="1">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="116,160,142,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
  ...
  <aliases>
    ...
    <alias index="2" field="classifica" name=""/>
    <alias index="3" field="featcode" name=""/>
  </aliases>
