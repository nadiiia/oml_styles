...
<qgis version="3.2.0-Bonn" simplifyLocal="1" simplifyAlgorithm="0" minScale="100000" simplifyDrawingTol="1" labelsEnabled="0" simplifyMaxScale="1" maxScale="28350" readOnly="0" hasScaleBasedVisibilityFlag="1" simplifyDrawingHints="1">
  <renderer-v2 symbollevels="0" type="categorizedSymbol" attr="classifica" forceraster="0" enableorderby="0">
    <categories>
      <category label="High Water Mark" symbol="0" render="true" value="High Water Mark"/>
      <category label="Low Water Mark" symbol="1" render="true" value="Low Water Mark"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol type="line" name="0" clip_to_extent="1" alpha="1">
        <layer class="SimpleLine" locked="0" pass="0" enabled="1">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="248,211,99,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
